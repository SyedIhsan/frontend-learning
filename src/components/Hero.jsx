  ...
  return (
    ...
    items-center justify-between min-h-[calc(90vh-6rem)]">
        ...
        className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
            ...
            tracking-wider max-w-[25rem] lg:max-w-[30rem]">
                Build and send emails from your applications
                with our powerful email API
                and reliable delivery platform.
            </p>
            ...
            <div className='flex gap-4 mt-12'>
                ...
                rounded-full sm:text-lg text-sm font-semibold tracking-wider
                transition-all duration-300 hover:bg-[#1a1a1a] hover:text-white bg-gray-300 text-black' href='#'>
        ...
        {/* 3D Robot */}
        <Spline data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="3000"
        className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[-2%] h-full' 
        scene="https://prod.spline.design/6tpvYBn0GGT0hlbh/scene.splinecode" />
